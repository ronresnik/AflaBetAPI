...
def test_short_title():
    with pytest.raises(ValueError, match="Title must be non-empty and between 5 and 255 characters long."):
        Event("Short", "Valid Description", "Valid Venue", "Valid Location",
              datetime.now() + timedelta(days=1), [], None)


def test_long_title():
    with pytest.raises(ValueError, match="Title must be non-empty and between 5 and 255 characters long."):
        Event("Too long title" * 30, "Valid Description", "Valid Venue", "Valid Location",
              datetime.now() + timedelta(days=1), [], None)


def test_empty_description():
    with pytest.raises(ValueError, match="Description must be non-empty and between 5 and 255 characters long."):
        Event("Valid Title", "", "Valid Venue", "Valid Location",
              datetime.now() + timedelta(days=1), [], None)


def test_short_description():
    with pytest.raises(ValueError, match="Description must be non-empty and between 5 and 255 characters long."):
        Event("Valid Title", "Short", "Valid Venue", "Valid Location",
              datetime.now() + timedelta(days=1), [], None)


def test_long_description():
    with pytest.raises(ValueError, match="Description must be non-empty and between 5 and 255 characters long."):
        Event("Valid Title", "Too long description" * 30, "Valid Venue", "Valid Location",
              datetime.now() + timedelta(days=1), [], None)


def test_empty_venue():
    with pytest.raises(ValueError, match="Venue must be non-empty and between 5 and 255 characters long."):
        Event("Valid Title", "Valid Description", "", "Valid Location",
              datetime.now() + timedelta(days=1), [], None)


def test_short_venue():
    with pytest.raises(ValueError, match="Venue must be non-empty and between 5 and 255 characters long."):
        Event("Valid Title", "Valid Description", "Short", "Valid Location",
              datetime.now() + timedelta(days=1), [], None)
...
def test_long_venue():
    with pytest.raises(ValueError, match="Venue must be non-empty and between 5 and 255 characters long."):
        Event("Valid Title", "Valid Description", "Too long venue" *
              30, "Valid Location", datetime.now() + timedelta(days=1), [], None)


def test_empty_tags():
    event = Event("Valid Title", "Valid Description", "Valid Venue", "Valid Location",
...
def test_negative_participants():
    with pytest.raises(ValueError, match="Participants must be greater than or equal to 1."):
        Event("Valid Title", "Valid Description", "Valid Venue", "Valid Location",
